...
const routingService = (view,origin,destination) => {
    ...
    const showStatistics = (stats) => {
        ...
        statistics.style.padding = "0 35px";
        ...
        icon.innerHTML = `<ul>
                            <li>${TourPinTearIcon} ${stats.places.origin}  >>>  ${stats.places.destination}</li>
                            <li>Average PM 2.5 rating: ${Number(stats.info.average).toFixed(3)}</li>
                        </ul>`
